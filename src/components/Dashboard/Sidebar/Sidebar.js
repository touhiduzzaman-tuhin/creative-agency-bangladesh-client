...
import { faCog, faSignOutAlt, faCartPlus, faHome, faCar, faComment, faUsers } from '@fortawesome/free-solid-svg-icons';
                ...
                {<div>
                    ...
                    <li>
                        <Link to="/serviceList" className="text-white">
                            <FontAwesomeIcon icon={faCar} /> <span>Service List</span>
                        </Link>
                    </li>
                    <li>
